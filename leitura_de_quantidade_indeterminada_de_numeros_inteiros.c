...
/*
1) LEITURA DE QUANTIDADE INDETERMINADA DE NÚMEROS INTEIROS
Faça um algoritmo que:
a) Leia uma quantidade indeterminada de números inteiros (parar quando o usuário digitar ‘0’
Zero)
b) Apresente a soma dos valores ímpares, a quantidade de valores pares.
c) Apresente o Maior valor e o Menor Valor. O zero (finalizador) NÃO deve ser considerado.
